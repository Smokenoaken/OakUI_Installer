...
local CATEGORY_TREE = {
    {
        ...
        description = "Shared fonts, textures, and addon-wide color settings.",
        recommended = false,
    },
    {
        id = "layout",
    ...
    },
    {
        ...
        description = "Cast bars, class resource bars, totems, and HUD resources.",
        recommended = true,
    },
    {
        id = "cdm",
        ...
        recommended = true,
        children = {
            { id = "cdmEssential", label = "Essential", description = "Essential cooldown rows and viewer settings.", recommended = true },
            { id = "cdmUtility", label = "Utility", description = "Utility cooldown rows and viewer settings.", recommended = true },
            { id = "cdmBuff", label = "Buff", description = "Buff icon styling and tracked buff bar settings.", recommended = true },
            { id = "cdmClassResourceBar", label = "Class Resource Bar", description = "Primary and secondary class resource bars.", recommended = true },
            { id = "cdmEffects", label = "Effects", description = "Glow effects, active animations, and buff border visuals.", recommended = true },
            { id = "cdmRotationAssist", label = "Rotation Assist", description = "Rotation-assist cooldown settings when present.", recommended = true },
            { id = "cdmKeybinds", label = "Keybinds", description = "CDM keybind display and OakUI keybind profile data.", recommended = true },
        },
    },
    {
        id = "actionBars",
    ...
    },
    {
        ...
        description = "Minimap, meter panel, friends panel, and related datatext settings.",
        recommended = true,
        children = {
            { id = "minimapSubtab", label = "Minimap", description = "Minimap frame and minimap utility settings.", recommended = true },
            { id = "datatextSubtab", label = "Datatext", description = "Damage meter and friends/datatext panel settings.", recommended = true },
        },
    },
    {
        id = "customCdmBars",
