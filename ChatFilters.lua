...
engine:SetScript("OnEvent", function()
    ChatFrame_AddMessageEventFilter("CHAT_MSG_CHANNEL", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_SAY", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_YELL", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_GUILD", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_OFFICER", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_PARTY", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_PARTY_LEADER", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_RAID", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_RAID_LEADER", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_INSTANCE_CHAT", FilterChannels)
    ChatFrame_AddMessageEventFilter("CHAT_MSG_INSTANCE_CHAT_LEADER", FilterChannels)
